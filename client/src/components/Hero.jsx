...
const Hero = () => {
    ...
    const word = useTypewriter({
        words: ['panic attack', 'insomnia', 'bipolar disorder', 'PTSD', 'suicidal tendencies', 'more'],
        loop: {},
    });
        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <p className="max-w-2xl py-4 mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">It gets much better from here. Get 1:1 help that works, and lasts — from the best in online therapy and psychiatry </p>
